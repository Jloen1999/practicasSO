/* Un proceso que crea un proceso hijo. El proceso hijo no finaliza hasta que el proceso padre no le envía la señal sigint. Cuando el proceso hijo recibe SIGINT, envia al padre la señal SIGUSR1  */
#include <stdio.h>
#include <stdlib.h>
#include <sys/types.h>
#include <unistd.h>
